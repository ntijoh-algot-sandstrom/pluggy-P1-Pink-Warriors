defmodule Pluggy.PizzaController do
  ...
  def index(conn) do
    send_resp(conn, 200, render("pizzas/index", pizzas_grouped: Pizza.pizza_grouped(), admin: User.is_admin?(conn)))
  end
  ...
  def edit(conn, id) do
    ...
    send_resp(conn, 200, render("pizzas/edit", pizza: pizza, remaining_ingredients: remaining, admin: User.is_admin?(conn)))
  end
